...
try:
    passwd_reset_form = settings.PASSWORD_RESET_FORM 
except:
    passwd_reset_form = SetPasswordForm

urlpatterns = patterns('',
     (r'^accounts/password/reset/$', password_reset, {  'template_name': 'password_reset/password_reset.html',
                                                        'email_template_name': 'password_reset/password_reset_email.html',
                                                        'post_reset_redirect': '/accounts/password/done/'}),
     (r'^accounts/password/done/$', password_reset_done, {'template_name': 'password_reset/password_reset_done.html'}),
