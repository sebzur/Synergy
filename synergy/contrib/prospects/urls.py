...
urlpatterns = patterns('',
                       ...
                       url(r'^detail/(?P<variant>[-\w]+)/(?P<pk>\d+)/(?P<parent>\d+)/$', views.DetailView.as_view(), name="detail"),
                       url(r'^context/(?P<variant>[-\w]+)/(?P<pk>\d+)/(?P<context>[-\w]+)/$', views.DetailContextView.as_view(), name="context"),
                       url(r'^context/(?P<variant>[-\w]+)/(?P<pk>\d+)/(?P<context>[-\w]+)/(?P<arguments>.+)/$', views.DetailContextView.as_view(), name="context"),
